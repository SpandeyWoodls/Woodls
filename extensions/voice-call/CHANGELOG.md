...
- Version alignment with core Woodls release numbers.
...
- First public release of the @woodls/voice-call plugin.
...
- CLI: `woodls voicecall` commands (call/start/continue/speak/end/status/tail/expose).
