...
import type { ReplyPayload, WoodlsConfig } from "woodls/plugin-sdk";
import { createReplyPrefixOptions } from "woodls/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as WoodlsConfig;
