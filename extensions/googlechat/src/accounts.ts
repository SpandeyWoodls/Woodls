...
export function listGoogleChatAccountIds(cfg: WoodlsConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: WoodlsConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: WoodlsConfig): ResolvedGoogleChatAccount[] {
