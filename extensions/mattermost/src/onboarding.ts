import type { ChannelOnboardingAdapter, WoodlsConfig, WizardPrompter } from "woodls/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.woodls.ai/channels/mattermost",
    ].join("\n"),
