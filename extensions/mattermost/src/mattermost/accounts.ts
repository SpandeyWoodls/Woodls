...
export function listMattermostAccountIds(cfg: WoodlsConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: WoodlsConfig): string {
...
export function listEnabledMattermostAccounts(cfg: WoodlsConfig): ResolvedMattermostAccount[] {
