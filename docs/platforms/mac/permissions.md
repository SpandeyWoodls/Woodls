...
- Same path: run the app from a fixed location (for Woodls, `dist/Woodls.app`).
...
Workaround: move files into the Woodls workspace (`~/.woodls/workspace`) if you want to avoid per-folder grants.
