...
This guide summarizes a sane workflow for working on the pi integration in Woodls.
...
- Trigger the agent directly:
  - `pnpm woodls agent --message "Hello" --thinking low`
...
State lives under the Woodls state directory. Default is `~/.woodls`. If `WOODLS_STATE_DIR` is set, use that directory instead.

To reset everything:

- `woodls.json` for config
...
- [https://docs.woodls.ai/testing](https://docs.woodls.ai/testing)
- [https://docs.woodls.ai/start/getting-started](https://docs.woodls.ai/start/getting-started)
