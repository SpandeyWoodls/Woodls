...
Woodls treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.woodls/settings/voicewake.json`

Shape:

```json
{ "triggers": ["woodls", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
