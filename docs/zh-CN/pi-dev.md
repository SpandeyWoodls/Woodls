...
本指南总结了在 Woodls 中开发 Pi 集成的合理工作流程。
...
状态存储在 Woodls 状态目录下。默认为 `~/.woodls`。如果设置了 `WOODLS_STATE_DIR`，则使用该目录。
...
- https://docs.woodls.ai/testing
- https://docs.woodls.ai/start/getting-started
