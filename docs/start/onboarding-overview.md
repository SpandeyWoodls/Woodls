---
summary: "Overview of Woodls onboarding options and flows"
read_when:
...
Woodls supports multiple onboarding paths depending on where the Gateway runs
...
- [`woodls onboard` command](/cli/onboard)

## macOS app onboarding

Use the Woodls app when you want a fully guided setup on macOS. Docs:
