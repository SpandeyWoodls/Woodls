---
summary: "First-run onboarding flow for Woodls (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Woodls">
...
<Step title="CLI">
  ...
  The app can install the global `woodls` CLI via npm/pnpm so terminal
