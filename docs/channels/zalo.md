...
- Install via CLI: `woodls plugins install @woodls/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `woodls plugins install ./extensions/zalo`
   - From npm (if published): `woodls plugins install @woodls/zalo`
...
- Approve via:
  - `woodls pairing list zalo`
  - `woodls pairing approve zalo <CODE>`
...
- Example: `woodls message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `woodls channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `woodls logs --follow`
