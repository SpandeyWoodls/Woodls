...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Woodls HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `woodls pairing approve slack <code>`.
...
Woodls supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Woodls falls back to normal delivery for remaining payloads.
