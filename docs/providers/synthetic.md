---
summary: "Use Synthetic's Anthropic-compatible API in Woodls"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Woodls registers it as the
...
Note: Woodls's Anthropic client appends `/v1` to the base URL, so use
