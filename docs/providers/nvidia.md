---
summary: "Use NVIDIA's OpenAI-compatible API in Woodls"
read_when:
  - You want to use NVIDIA models in Woodls
...
woodls onboard --auth-choice skip
woodls models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
