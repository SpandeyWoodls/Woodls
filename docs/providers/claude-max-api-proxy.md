...
You can point Woodls at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Woodls
...
- [Anthropic provider](/providers/anthropic) - Native Woodls integration with Claude setup-token or API keys
