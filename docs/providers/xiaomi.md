---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Woodls"
read_when:
  - You want Xiaomi MiMo models in Woodls
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Woodls uses
