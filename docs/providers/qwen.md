---
summary: "Use Qwen OAuth (free tier) in Woodls"
read_when:
  - You want to use Qwen with Woodls
...
If you already logged in with the Qwen Code CLI, Woodls will sync credentials
