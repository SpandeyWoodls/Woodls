---
summary: "Use Qianfan's unified API to access many models in Woodls"
read_when:
...
3. Woodls installed on your system
...
4. Copy the API key for use with Woodls

## CLI setup

```bash
woodls onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Woodls Configuration](/gateway/configuration)
