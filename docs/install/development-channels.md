...
Woodls ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Woodls also aligns
the install method:
...
When you switch channels with `woodls update`, Woodls also syncs plugin sources:
