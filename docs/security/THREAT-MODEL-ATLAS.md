...
This is a living document maintained by the Woodls community. See [CONTRIBUTING-THREAT-MODEL.md](./CONTRIBUTING-THREAT-MODEL.md) for guidelines on contributing:
...
This threat model documents adversarial threats to the Woodls AI agent platform and WoodlsHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component            | Included | Notes                                            |
| -------------------- | -------- | ------------------------------------------------ |
| Woodls Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
| Gateway              | Yes      | Authentication, routing, channel integration     |
| Channel Integrations | Yes      | WhatsApp, Telegram, Discord, Signal, Slack, etc. |
| WoodlsHub Marketplace  | Yes      | Skill publishing, moderation, distribution       |
...
| F5   | WoodlsHub | Agent       | Skill code         | Moderation, scanning |
...
| **Description**         | Attacker scans for exposed Woodls gateway endpoints                  |
...
| **Affected Components** | ~/.woodls/credentials/, config storage                      |
...
| **Description**         | Attacker publishes malicious skill to WoodlsHub                            |
| **Attack Vector**       | Create account, publish skill with hidden malicious code                 |
| **Affected Components** | WoodlsHub, skill loading, agent execution                                  |
...
| **Affected Components** | WoodlsHub versioning, auto-update flows                          |
...
| **Affected Components** | WoodlsHub moderation.ts                                                  |
...
## 4. WoodlsHub Supply Chain Analysis
...
/(keepcold131\/WoodlsAuthenticatorTool|WoodlsAuthenticatorTool)/i
...
| ATLAS ID      | Technique Name                 | Woodls Threats                                                   |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| `convex/lib/moderation.ts`          | WoodlsHub moderation          | **High**     |
...
| **WoodlsHub**          | Woodls's skill marketplace                                |
| **Gateway**          | Woodls's message routing and authentication layer         |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for Woodls agents                  |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@woodls.ai_
