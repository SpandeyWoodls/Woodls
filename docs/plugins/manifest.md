...
read_when:
  - You are building a Woodls plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (woodls.plugin.json)

Every plugin **must** ship a `woodls.plugin.json` file in the **plugin root**.
Woodls uses this manifest to validate configuration **without executing plugin
