...
final class WoodlsAppDelegate: NSObject, UIApplicationDelegate {
    private let logger = Logger(subsystem: "ai.woodls.ios", category: "Push")
...
@main
struct WoodlsApp: App {
    @State private var appModel: NodeAppModel
    @State private var gatewayController: GatewayConnectionController
    @UIApplicationDelegateAdaptor(WoodlsAppDelegate.self) private var appDelegate
...
extension WoodlsApp {
    private static func installUncaughtExceptionLogger() {
        NSLog("Woodls: installing uncaught exception handler")
