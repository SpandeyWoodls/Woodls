...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.woodls.gateway"
    private static let nodeService = "ai.woodls.node"
    private static let talkService = "ai.woodls.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.woodls.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.woodls.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("woodls-gateway.log")
    }
