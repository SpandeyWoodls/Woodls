...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: WoodlsPhotosLatestParams) async throws -> WoodlsPhotosLatestPayload {
        ...
        var results: [WoodlsPhotoPayload] = []
        ...
        return WoodlsPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> WoodlsPhotoPayload
    {
