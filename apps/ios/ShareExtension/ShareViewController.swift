...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.woodls.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to Woodls", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to Woodls gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to Woodls.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "WoodlsShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "Woodls is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "Woodls Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("woodls-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
