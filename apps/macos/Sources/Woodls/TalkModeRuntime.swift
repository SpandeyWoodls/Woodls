...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.woodls", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.woodls", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [WoodlsChatMessage] = messages.compactMap { item in
