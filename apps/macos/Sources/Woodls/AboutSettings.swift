...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/woodls/woodls") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/woodls/woodls")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://woodls.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "WoodlsBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "WoodlsBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "WoodlsGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "WoodlsGitCommit") as? String) ??
            "unknown"
    }
