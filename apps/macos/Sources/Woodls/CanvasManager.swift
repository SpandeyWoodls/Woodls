...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.woodls", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Woodls/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__woodls__/a2ui/").absoluteString + "?platform=macos"
    }
