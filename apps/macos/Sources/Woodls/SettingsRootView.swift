...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .woodlsSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? WoodlsPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? WoodlsPaths.stateDirURL.path
...
extension Notification.Name {
    static let woodlsSelectSettingsTab = Notification.Name("woodlsSelectSettingsTab")
}
