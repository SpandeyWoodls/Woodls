...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.woodls", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Woodls windows, but below the system’s pop-up menus.
