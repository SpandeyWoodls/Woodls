...
enum UIStrings {
    static let welcomeTitle = "Welcome to Woodls"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "woodls.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: WoodlsOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: WoodlsChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g woodls@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: WoodlsChatViewModel(
