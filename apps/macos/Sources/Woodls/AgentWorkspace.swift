...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.woodls", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return WoodlsConfigFile.defaultWorkspaceURL() }
