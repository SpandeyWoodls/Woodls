...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.woodls", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".woodls/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.woodlsCommand(
            subcommand: "gateway",
