...
enum WoodlsConfigFile {
    private static let logger = Logger(subsystem: "ai.woodls", category: "config")
    ...
    static func stateDirURL() -> URL {
        WoodlsPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        WoodlsPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-woodls-config-file",
            "event": "config.write",
