...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = WoodlsConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = WoodlsConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = WoodlsConfigFile.loadDict()
            ...
            WoodlsConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/woodls"
        state.remoteCliPath = ""
        return state
    }
}
