...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Woodls token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: WoodlsOAuthStore.AnthropicOAuthStatus = WoodlsOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.woodls", category: "anthropic-oauth")
...
enum WoodlsOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let woodlsOAuthDirEnv = "WOODLS_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Woodls OAuth token file not found"
            case .unreadableFile: "Woodls OAuth token file not readable"
            case .invalidJSON: "Woodls OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Woodls OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Woodls OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.woodlsOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".woodls", isDirectory: true)
