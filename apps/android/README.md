## Woodls Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_woodls-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm woodls gateway --port 18789 --verbose
```
