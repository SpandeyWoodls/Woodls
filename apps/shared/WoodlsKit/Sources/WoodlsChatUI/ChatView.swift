...
@MainActor
public struct WoodlsChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: WoodlsChatViewModel
    ...
    private var visibleMessages: [WoodlsChatMessage] {
        let base: [WoodlsChatMessage]
    ...
    private func mergeToolResults(in messages: [WoodlsChatMessage]) -> [WoodlsChatMessage] {
    ...
    private func isToolResultMessage(_ message: WoodlsChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: WoodlsChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: WoodlsChatMessage) -> String {
