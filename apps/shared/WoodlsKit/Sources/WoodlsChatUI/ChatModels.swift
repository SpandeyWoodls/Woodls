...
public typealias WoodlsPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias WoodlsPlatformImage = UIImage
#endif

public struct WoodlsChatUsageCost: Codable, Hashable, Sendable {
...
public struct WoodlsChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: WoodlsChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(WoodlsChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct WoodlsChatMessageContent: Codable, Hashable, Sendable {
...
public struct WoodlsChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [WoodlsChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: WoodlsChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [WoodlsChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: WoodlsChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(WoodlsChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([WoodlsChatMessageContent].self, forKey: .content) {
...
public struct WoodlsChatHistoryPayload: Codable, Sendable {
...
public struct WoodlsSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct WoodlsSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [WoodlsSessionPreviewItem]
}

public struct WoodlsSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [WoodlsSessionPreviewEntry]

    public init(ts: Int, previews: [WoodlsSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct WoodlsChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct WoodlsChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct WoodlsAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct WoodlsChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct WoodlsGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct WoodlsPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: WoodlsPlatformImage?
...
public struct WoodlsChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
