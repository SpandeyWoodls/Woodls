# Contributing to Woodls

## Quick Links

- **GitHub:** https://github.com/woodls/woodls
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/woodls/woodls/discussions) or ask in Discord first
3. **Questions** → Discord #setup-help

## Before You PR

- Test locally with your Woodls instance
...
If you're an experienced contributor who wants to help shape Woodls's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@woodls.ai with:

- Links to your PRs on Woodls (if you don't have any, start there first)
