...
# Defaults target the Woodls assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Woodls/Resources/Woodls.icns"}
