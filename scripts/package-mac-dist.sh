...
# Output:
# - dist/Woodls.app
# - dist/Woodls-<version>.zip
# - dist/Woodls-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Woodls-$VERSION.zip"
DMG="$ROOT_DIR/dist/Woodls-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Woodls-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Woodls-$VERSION.dSYM.zip"
