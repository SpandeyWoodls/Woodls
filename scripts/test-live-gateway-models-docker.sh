...
docker run --rm -t \
  ...
  -e WOODLS_LIVE_GATEWAY_MODELS="${WOODLS_LIVE_GATEWAY_MODELS:-${WOODLS_LIVE_GATEWAY_MODELS:-all}}" \
  -e WOODLS_LIVE_GATEWAY_PROVIDERS="${WOODLS_LIVE_GATEWAY_PROVIDERS:-${WOODLS_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e WOODLS_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${WOODLS_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${WOODLS_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
