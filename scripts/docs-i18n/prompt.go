...
- Keep product names in English: Woodls, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Woodls Gateway, use “Gateway 网关”.
