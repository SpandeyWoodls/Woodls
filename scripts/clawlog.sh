...
show_usage() {
    cat << EOF
clawlog - Woodls Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Woodls logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Woodls logs flow through the macOS unified log (subsystem: ai.woodls).
