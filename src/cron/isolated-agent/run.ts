...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/woodls/woodls/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.WOODLS_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.woodls/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: WoodlsConfig = {
    ...params.cfg,
