...
describe("agent components", () => {
  const createCfg = (): WoodlsConfig => ({}) as WoodlsConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockReset().mockReturnValue("/tmp/woodls-sessions-test.json");
  });
