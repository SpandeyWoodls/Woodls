...
const resolveStorePath = vi.fn(() => "/tmp/woodls-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/woodls-discord-process-test-sessions.json");
});
