...
function mergeDiscordAccountConfig(cfg: WoodlsConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: WoodlsConfig): ResolvedDiscordAccount[] {
