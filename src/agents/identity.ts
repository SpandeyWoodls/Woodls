import type { WoodlsConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: WoodlsConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: WoodlsConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[woodls]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: WoodlsConfig, channel: string): Record<string, unknown> | undefined {
