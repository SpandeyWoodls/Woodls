...
export function resolveSessionToolsVisibility(cfg: WoodlsConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: WoodlsConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: WoodlsConfig): AgentToAgentPolicy {
