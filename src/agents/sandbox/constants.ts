...
export const DEFAULT_SANDBOX_IMAGE = "woodls-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "woodls-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "woodls-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "woodls-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "woodls-sbx-browser-";
