...
function resolveMainSessionKeyForSandbox(params: { cfg?: WoodlsConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: WoodlsConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`woodls sandbox explain --session ${runtime.sessionKey}`)}`,
  );
