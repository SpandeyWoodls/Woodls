...
describe("createWoodlsCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createWoodlsCodingTools({
      config,
    ...
    const anthropicTools = createWoodlsCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createWoodlsCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createWoodlsCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
