...
function makeCfg(overrides: Partial<WoodlsConfig> = {}): WoodlsConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): WoodlsConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): WoodlsConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
