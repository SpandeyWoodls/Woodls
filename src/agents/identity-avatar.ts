...
function resolveAvatarSource(cfg: WoodlsConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: WoodlsConfig, agentId: string): AgentAvatarResolution {
