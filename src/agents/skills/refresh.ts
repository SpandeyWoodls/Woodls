...
function resolveWatchPaths(workspaceDir: string, config?: WoodlsConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: WoodlsConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: WoodlsConfig }) {
