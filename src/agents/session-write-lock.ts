...
const CLEANUP_STATE_KEY = Symbol.for("woodls.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("woodls.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("woodls.sessionWriteLockWatchdogState");
