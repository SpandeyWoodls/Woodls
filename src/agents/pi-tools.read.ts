...
function resolveAdaptiveReadMaxBytes(options?: WoodlsReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createWoodlsReadTool(base, {
...
export function createWoodlsReadTool(
  base: AnyAgentTool,
  options?: WoodlsReadToolOptions,
): AnyAgentTool {
