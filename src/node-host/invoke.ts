...
const execHostEnforced = process.env.WOODLS_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.WOODLS_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
