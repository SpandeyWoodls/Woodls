...
export function listChannelMessageActions(cfg: WoodlsConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: WoodlsConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: WoodlsConfig): boolean {
  for (const plugin of listChannelPlugins()) {
