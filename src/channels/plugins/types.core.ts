...
export type ChannelAgentToolFactory = (params: { cfg?: WoodlsConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: WoodlsConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: WoodlsConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: WoodlsConfig }) => boolean;
  supportsCards?: (params: { cfg: WoodlsConfig }) => boolean;
