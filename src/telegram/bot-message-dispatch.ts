...
import type { WoodlsConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: WoodlsConfig, agentId: string) {
  try {
