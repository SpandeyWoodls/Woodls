...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@woodls", { botUsername: "woodls" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@woodls args", {
        botUsername: "woodls",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "woodls" })).toBe(
      "/help@otherbot",
    );
  });
