...
function resolveMentionPatterns(cfg: WoodlsConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: WoodlsConfig | undefined, agentId?: string): RegExp[] {
