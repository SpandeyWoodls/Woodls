...
export function listWhatsAppAuthDirs(cfg: WoodlsConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: WoodlsConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: WoodlsConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: WoodlsConfig): ResolvedWhatsAppAccount[] {
