...
const SANDBOX_EXAMPLES = {
  main: [
    ["woodls sandbox list", "List all sandbox containers."],
    ["woodls sandbox list --browser", "List only browser containers."],
    ["woodls sandbox recreate --all", "Recreate all containers."],
    ["woodls sandbox recreate --session main", "Recreate a specific session."],
    ["woodls sandbox recreate --agent mybot", "Recreate agent containers."],
    ["woodls sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["woodls sandbox list", "List all sandbox containers."],
    ["woodls sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["woodls sandbox recreate --all", "Recreate all containers."],
    ["woodls sandbox recreate --session main", "Recreate a specific session."],
    ["woodls sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["woodls sandbox recreate --browser --all", "Recreate only browser containers."],
    ["woodls sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["woodls sandbox explain", "Show effective sandbox config."],
    ["woodls sandbox explain --session agent:main:main", "Explain a specific session."],
    ["woodls sandbox explain --agent work", "Explain an agent sandbox."],
    ["woodls sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.woodls.ai/cli/sandbox")}\n`,
    )
    .action(() => {
