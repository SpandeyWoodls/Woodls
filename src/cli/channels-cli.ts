    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["woodls channels list", "List configured channels and auth profiles."],
          ["woodls channels status --probe", "Run channel status checks and probes."],
          [
            "woodls channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["woodls channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.woodls.ai/cli/channels",
        )}\n`,
    );
