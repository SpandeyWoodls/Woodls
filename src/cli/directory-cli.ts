    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["woodls directory self --channel slack", "Show the connected account identity."],
          [
            'woodls directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["woodls directory groups list --channel discord", "List available groups/channels."],
          [
            "woodls directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.woodls.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
