...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @woodls/voice-call -> voice-call).
...
export function discoverWoodlsPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".woodls", "extensions")];
