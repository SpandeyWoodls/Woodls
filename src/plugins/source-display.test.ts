...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/woodls/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/woodls/extensions",
        global: "/Users/x/.woodls/extensions",
        workspace: "/Users/x/ws/.woodls/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.woodls/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/woodls/extensions",
        global: "/Users/x/.woodls/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.woodls/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/woodls/extensions",
        global: "/Users/x/.woodls/extensions",
