...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.WOODLS_STATE_DIR;
  const configPath = env.WOODLS_CONFIG_PATH;
  ...
  return {
    ...
    WOODLS_PROFILE: profile,
    WOODLS_STATE_DIR: stateDir,
    WOODLS_CONFIG_PATH: configPath,
    WOODLS_GATEWAY_PORT: String(port),
    WOODLS_GATEWAY_TOKEN: token,
    WOODLS_LAUNCHD_LABEL: resolvedLaunchdLabel,
    WOODLS_SYSTEMD_UNIT: systemdUnit,
    WOODLS_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    WOODLS_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    WOODLS_STATE_DIR: stateDir,
    WOODLS_CONFIG_PATH: configPath,
    WOODLS_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    WOODLS_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    WOODLS_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    WOODLS_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    WOODLS_LOG_PREFIX: "node",
    WOODLS_SERVICE_MARKER: NODE_SERVICE_MARKER,
    WOODLS_SERVICE_KIND: NODE_SERVICE_KIND,
    WOODLS_SERVICE_VERSION: VERSION,
  };
}
