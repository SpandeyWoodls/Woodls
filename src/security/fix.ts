...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof WoodlsConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: WoodlsConfig; env: NodeJS.ProcessEnv }): {
  cfg: WoodlsConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
