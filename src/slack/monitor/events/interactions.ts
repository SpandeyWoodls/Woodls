...
// Prefix for Woodls-generated action IDs to scope our handler
const WOODLS_ACTION_PREFIX = "woodls:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle Woodls modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${WOODLS_ACTION_PREFIX}`),
