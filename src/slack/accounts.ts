...
function mergeSlackAccountConfig(cfg: WoodlsConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: WoodlsConfig): ResolvedSlackAccount[] {
