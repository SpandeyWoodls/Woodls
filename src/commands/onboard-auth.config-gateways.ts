...
export function applyVercelAiGatewayProviderConfig(cfg: WoodlsConfig): WoodlsConfig {
...
export function applyVercelAiGatewayConfig(cfg: WoodlsConfig): WoodlsConfig {
