...
function resolveDefaultAccountId(cfg: WoodlsConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: WoodlsConfig): boolean {
...
export function summarizeBindings(cfg: WoodlsConfig, bindings: AgentBinding[]): string[] {
