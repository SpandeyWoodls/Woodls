...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.woodls.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("woodls hooks list")}`,
      `  ${formatCliCommand("woodls hooks enable <name>")}`,
      `  ${formatCliCommand("woodls hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
