...
type PromptDefaultModelResult = { model?: string; config?: WoodlsConfig };
...
function resolveConfiguredModelRaw(cfg: WoodlsConfig): string {
...
function resolveConfiguredModelKeys(cfg: WoodlsConfig): string[] {
...
export function applyPrimaryModel(cfg: WoodlsConfig, model: string): WoodlsConfig {
...
export function applyModelAllowlist(cfg: WoodlsConfig, models: string[]): WoodlsConfig {
  const defaults = cfg.agents?.defaults;
