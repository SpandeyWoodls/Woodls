...
import type { WoodlsPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: WoodlsPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: WoodlsPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
