...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.WOODLS_TTS_PREFS;
      process.env.WOODLS_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.WOODLS_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: WoodlsConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
