...
import { createWoodlsTools } from "../agents/woodls-tools.js";
...
export async function handleToolsInvokeHttpRequest(
  ...
  const messageChannel = normalizeMessageChannel(getHeader(req, "x-woodls-message-channel") ?? "");
  const accountId = getHeader(req, "x-woodls-account-id")?.trim() || undefined;
  ...
  const allTools = createWoodlsTools({
