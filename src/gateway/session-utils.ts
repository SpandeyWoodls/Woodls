...
import { type WoodlsConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: WoodlsConfig): string[] {
...
export function listAgentsForGateway(cfg: WoodlsConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: WoodlsConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: WoodlsConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: WoodlsConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: WoodlsConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: WoodlsConfig): GatewaySessionsDefaults {
