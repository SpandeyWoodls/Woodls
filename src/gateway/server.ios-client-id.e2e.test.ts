...
beforeAll(async () => {
  previousToken = process.env.WOODLS_GATEWAY_TOKEN;
  process.env.WOODLS_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "woodls-ios", platform: "ios" },
  { clientId: "woodls-android", platform: "android" },
