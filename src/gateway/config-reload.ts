...
import type { WoodlsConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: WoodlsConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: WoodlsConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: WoodlsConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: WoodlsConfig) => void;
  log: {
