...
function resolveAnthropicDefaultAuthMode(cfg: WoodlsConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: WoodlsConfig): WoodlsConfig {
...
export function applyTalkApiKey(config: WoodlsConfig): WoodlsConfig {
...
export function applyModelDefaults(cfg: WoodlsConfig): WoodlsConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: WoodlsConfig): WoodlsConfig {
...
export function applyLoggingDefaults(cfg: WoodlsConfig): WoodlsConfig {
...
export function applyContextPruningDefaults(cfg: WoodlsConfig): WoodlsConfig {
...
export function applyCompactionDefaults(cfg: WoodlsConfig): WoodlsConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
