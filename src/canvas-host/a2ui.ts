...
export const A2UI_PATH = "/__woodls__/a2ui";

export const CANVAS_HOST_PATH = "/__woodls__/canvas";

export const CANVAS_WS_PATH = "/__woodls__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.woodlsCanvasA2UIAction.postMessage(...)
  // - Android: window.woodlsCanvasA2UIAction.postMessage(...)
  const handlerNames = ["woodlsCanvasA2UIAction"];
  ...
  globalThis.Woodls = globalThis.Woodls ?? {};
  globalThis.Woodls.postMessage = postToNode;
  globalThis.Woodls.sendUserAction = sendUserAction;
  globalThis.woodlsPostMessage = postToNode;
  globalThis.woodlsSendUserAction = sendUserAction;
