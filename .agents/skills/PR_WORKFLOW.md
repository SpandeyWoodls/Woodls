...
- Manual post-merge step for new contributors: run `bun scripts/update-contributors.ts` to add their avatar to the README "Thanks to all contributors" list, then commit the regenerated README.
...
- Read `docs/help/submitting-a-pr.md` ([Submitting a PR](https://docs.woodls.ai/help/submitting-a-pr)) for what we expect from contributors.
