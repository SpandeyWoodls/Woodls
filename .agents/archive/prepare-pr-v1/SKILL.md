...
- `fix: <summary> (woodls#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (woodls#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "woodls#$pr_number" || { echo "ERROR: commit subject missing woodls#$pr_number"; exit 1; }
